...
- **Overdraft (OD) Eligibility**
- **Serviceability Check** (whether the customer’s area is serviceable or not)
- **Balance Transfer Eligibility**
- **Bank Profile Assessment** (whether banks will process the case based on other factors, which may be identified later)
...
- Improve customer experience by offering faster loan decisions.
- Enable banks to handle more applications efficiently.
...
- **Gradio / Streamlit** for user-friendly interfaces
- **Excel / Power Query** for reporting and analysis
...
- Advanced risk assessment using machine learning models.
- Dashboard for banks to visualize eligibility trends.
